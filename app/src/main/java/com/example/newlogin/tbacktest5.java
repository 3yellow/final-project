...
public class tbacktest5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tbacktest5);
        ...
        Que.setText("1.血液每次沖洗消毒後均應_____，確保安全。");
    ...
    public void BACK(View v) {
        intent.setClass(this, choose_education.class);
